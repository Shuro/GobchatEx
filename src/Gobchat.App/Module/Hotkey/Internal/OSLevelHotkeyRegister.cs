...
namespace Gobchat.Module.Hotkey.Internal
{
    ...
    internal sealed class OSLevelHotkeyRegister : IDisposable
    {
        ...
        /// <exception cref="HotkeyRegisterException"></exception>
        ...
        {
            var success = _synchronizer.RunSync(() => UnregisterHotKey(_hiddenWindow.Handle, id));
            return success;
        }
