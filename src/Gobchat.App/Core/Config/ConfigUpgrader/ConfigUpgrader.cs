    ...
    internal sealed class ConfigUpgrader
    {
        ...
        public ConfigUpgrader()
        {
            _upgrades = new IConfigUpgrade[]
            {
                ...
                new ConfigUpgrade_2_0_0(),
                new ConfigUpgrade_2_0_1(),
                new ConfigUpgrade_2_0_2(),
                new ConfigUpgrade_2_0_3(),
                new ConfigUpgrade_2_0_4(),
                new ConfigUpgrade_2_0_5(),
                new ConfigUpgrade_2_0_6(),
                new ConfigUpgrade_2_0_7(),
                new ConfigUpgrade_2_0_8(),
                new ConfigUpgrade_2_0_9(),
                new ConfigUpgrade_2_0_10(),
                new ConfigUpgrade_2_0_11(),
                new ConfigUpgrade_2_0_12()
            };
        }
