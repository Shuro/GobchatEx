...
// WinForms-targeted production assembly (which carries that attribute). Restore it manually
// (windows7.0 = the net10.0-windows default floor), matching the production AssemblyInfo files.
