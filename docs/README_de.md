...
- **Textausrichtung** - richte den Chat-Nachrichtentext links (Standard), zentriert, rechts oder im Blocksatz aus; der vorangestellte `[Zeit]`-Stempel bleibt stets am linken Rand (*Einstellungen → Formatierung*).
